...
- [x] 1. Set up commitlint for conventional commit enforcement
...
- [ ] 2. Configure semantic-release
  - [x] 2.1 Install semantic-release and required plugins
  ...
  - [x] 2.2 Create semantic-release configuration file
